new Object({
  functionMap: {
    ...
    DEFAULTDELAY: function(argList, µ) {
      argList.shift();
      if(argList.length < 1) {
  ...
  getFinalCode: function(compiledCode) {
    return '/**\n'
    + ' * Made with DuckDuino By Nakshatra Ranjan Saha (OCEAN OF ANYTHING)\n'
    + ' * Check the DuckDuino Online Tool at \'https://oceanofanythingofficial.github.io/DuckDuino/\'\n'
    + '**/\n\n'
